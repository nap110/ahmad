...
class Welcome52 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    ...
    Container(
      ...
      child: Container(
        padding: EdgeInsets.fromLTRB(33.7, 331, 33, 24),
        child: Stack(
          ...
          children: [
            ...
            SizedBox(
              ...
              child: Column(
                ...
                children: [
                  Container(
                    margin: EdgeInsets.fromLTRB(0, 0, 5.7, 15),
                    child: Text(
                      'Create your account',
                  ...
                  Container(
                    margin: EdgeInsets.fromLTRB(3.3, 0, 9, 9),
                    decoration: BoxDecoration(
                  ...
                  Container(
                    margin: EdgeInsets.fromLTRB(0, 0, 31, 41),
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.start,
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                  ...
                  Container(
                    margin: EdgeInsets.fromLTRB(0, 0, 5.7, 46),
                    child: Text(
                      'Sign Up',
                  ...
                  Container(
                    margin: EdgeInsets.fromLTRB(0.3, 0, 0, 32),
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.start,
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                  ...
                  Container(
                    margin: EdgeInsets.fromLTRB(7.3, 0, 0, 22),
                    child: SizedBox(
                      width: 219,
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.start,
                  ...
                  Container(
                    margin: EdgeInsets.fromLTRB(18.6, 0, 3.3, 0),
                    child: RichText(
                      text: TextSpan(
                        text: 'Already',
                        style: GoogleFonts.getFont(
